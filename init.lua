...
local function ore(ab_stra, y, ORET, ybig, n_strata, data, vi, OREID)
	...
	if ab_stra >= ore_t then
		...
		elseif ystrata > -t1    --strata splits
		and ystrata < 0 then
			data[vi] = OREID.c_chrom
			return true
		--tali
		elseif ystrata > -t1    --strata splits
		and ystrata < t1 then
			data[vi] = OREID.c_tali
			return true
		--lead
		elseif ystrata > -t1    --strata splits
		and ystrata < 0 then
			data[vi] = OREID.c_lead
			return true
		--alatro
		elseif ystrata > -t2    --strata splits
		and ystrata < 0 then
			data[vi] = OREID.c_alatro
			return true
		--arol
		elseif ystrata > -t2    --strata splits
		and ystrata < -t1 then
			data[vi] = OREID.c_arol
			return true
		--amethyst
		elseif ystrata > -t3    --strata splits
		and ystrata < -t2 then
			data[vi] = OREID.c_amethyst
			return true
		--topaz
		elseif ystrata > -t3    --strata splits
		and ystrata < 0 then
			data[vi] = OREID.c_topaz
			return true
		--copper
		elseif ystrata > t1    --strata splits
		and ystrata < t2 then
		...
		and ystrata > -t3    --strata splits
		and ystrata < -t2 then
			data[vi] = OREID.c_ruby
			return true
		--Sapphire
		elseif y < orehmax_d
		and ystrata > -t3    --strata splits
		and ystrata < -t2 then
			data[vi] = OREID.c_sapphire
			return true
		--Mese
		elseif y < orehmax_m
...
local c_adobe = minetest.get_content_id("building_blocks:Adobe")
local c_pumice = minetest.get_content_id("gloopblocks:pumice")
local c_obsid = minetest.get_content_id("default:obsidian")
local c_marble = minetest.get_content_id("technic:marble")
local c_ironstone = minetest.get_content_id("moreblocks:iron_stone")
local c_granite = minetest.get_content_id("technic:granite")
local c_dirtstone = minetest.get_content_id("usesdirt:dirt_stone")
local c_coral = minetest.get_content_id("default:coral_skeleton")
local c_coalstone = minetest.get_content_id("moreblocks:coal_stone")
local c_basalt = minetest.get_content_id("gloopblocks:basalt")

--sediments
local SEDID = {
 			c_gravel = minetest.get_content_id("default:gravel"),
 			c_gravelc = minetest.get_content_id("pedology:gravel_coarse_0"),
 			c_gravelm = minetest.get_content_id("pedology:gravel_medium_0"),
 			c_gravelf = minetest.get_content_id("pedology:gravel_fine_0"),
 			c_clay = minetest.get_content_id("default:clay"),
 			c_claym = minetest.get_content_id("pedology:clay_0"),
 			c_sand = minetest.get_content_id("default:sand"),
 			c_sand2 = minetest.get_content_id("default:silver_sand"),
 			c_sandc = minetest.get_content_id("pedology:sand_coarse_0"),
 			c_sandm = minetest.get_content_id("pedology:sand_medium_0"),
 			c_sandf = minetest.get_content_id("pedology:sand_fine_0"),
 			c_dirt = minetest.get_content_id("default:dirt"),
 			c_siltm = minetest.get_content_id("pedology:silt_medium_0"),
 			c_siltf = minetest.get_content_id("pedology:silt_fine_0"),
 			c_siltc = minetest.get_content_id("pedology:silt_coarse_0"),
 			c_trufh = minetest.get_content_id("pedology:turf_hemic_0"),
 			c_turff = minetest.get_content_id("pedology:turf_fibric_0"),
  			c_turfs = minetest.get_content_id("pedology:turf_sapric_0")
}
...
local MISCID = {
		...
		c_corium = minetest.get_content_id("technic:corium_source"),
		c_fwater = minetest.get_content_id("pedology:water_fresh_source")
}
...
local OREID = {
		...
		c_iron2 = minetest.get_content_id("glooptest:mineral_desert_iron"),
		c_coal = minetest.get_content_id("default:stone_with_coal"),
		c_coal2 = minetest.get_content_id("glooptest:mineral_desert_coal"),
		c_titan = minetest.get_content_id("titanium:titanium_in_ground"),
		c_quartz = minetest.get_content_id("quartz:quartz_ore"),
		c_tali = minetest.get_content_id("glooptest:mineral_talinite"),
		c_lead = minetest.get_content_id("technic:mineral_lead"),
		c_akalin = minetest.get_content_id("glooptest:mineral_akalin"),
		c_alatro = minetest.get_content_id("glooptest:mineral_alatro"),
		c_amethyst = minetest.get_content_id("glooptest:mineral_amethyst"),
		c_arol = minetest.get_content_id("glooptest:mineral_arol"),
		c_emerald = minetest.get_content_id("glooptest:mineral_emerald"),
		c_kalite = minetest.get_content_id("glooptest:mineral_kalite"),
		c_ruby = minetest.get_content_id("glooptest:mineral_ruby"),
		c_sapphire = minetest.get_content_id("glooptest:mineral_sapphire"),
		c_topaz = minetest.get_content_id("glooptest:mineral_topaz"),
		c_glowore = minetest.get_content_id("blox:glowore"),
		c_mithril = minetest.get_content_id("moreores:mineral_mithril"),
		c_silver = minetest.get_content_id("moreores:mineral_silver"),
		c_chrom = minetest.get_content_id("technic:mineral_chromium"),
		c_sulfur = minetest.get_content_id("technic:mineral_sulfur"),
				 	...
				 	then
						...
						then
							...
							elseif roll == 5 then
								...
								void = false
							elseif roll == 6 then
								data[vi] = OREID.c_uranium
								void = false
							elseif roll == 7 then
								data[vi] = OREID.c_sulfur
								void = false
							elseif roll == 8 then
								data[vi] = OREID.c_mithril
								void = false
							elseif roll == 9 then
								data[vi] = OREID.c_glowore
								void = false
							elseif roll == 10 then
								data[vi] = OREID.c_lead
								void = false
							elseif roll == 11 then
								...
								void = false
							elseif roll == 12 then
								data[vi] = OREID.c_zinc
								void = false
							elseif roll == 13 then
								data[vi] = OREID.c_titan
								void = false
							elseif roll == 14 then
								data[vi] = OREID.c_emerald
								void = false
							...
							elseif roll == 21 then
								...
								void = false
							elseif roll == 22 then
								data[vi] = OREID.c_akalin
								void = false
							elseif roll == 23 then
								data[vi] = OREID.c_silver
								void = false
							elseif roll == 24 then
								data[vi] = OREID.c_iron
								void = false
							elseif roll == 25 then
								...
								void = false
							elseif roll == 26 then
								data[vi] = OREID.c_quartz
								void = false
							elseif roll == 27 then
								data[vi] = OREID.c_kalite
								void = false
							else
								data[vi] = c_obsid
								void = false
							...
							elseif nocave then
								...
								elseif ystrata >= 0 then
									...
									elseif math.random(1,1000) == 2 then
										data[vi] = OREID.c_coal
										void = false
									elseif math.random(1,1000) == 3 then
										data[vi] = OREID.c_mithril
										void = false
									elseif math.random(1,1000) == 4 then
										data[vi] = OREID.c_lead
										void = false
									elseif math.random(1,1000) == 5 then
										data[vi] = OREID.c_zinc
										void = false
									elseif math.random(1,1000) == 6 then
										data[vi] = OREID.c_titan
										void = false
									--grey stone
									else
								...
								--red stone layer...
								elseif ystrata < 0 then
									--small chance of some iron2 and coal2
									if math.random(1,1000) == 1 then
										data[vi] = OREID.c_iron2
										void = false
									elseif math.random(1,1000) == 2 then
										data[vi] = OREID.c_coal2
										void = false
									--red stone
									else
										data[vi] = c_stone2
								...
								if nocave then
									...
									and n_strata > 0.8 then
										...
										elseif math.random(1,500) == 2 then
											data[vi] = OREID.c_iron
											void = false
										elseif math.random(1,500) == 3 then
											data[vi] = OREID.c_mithril
											void = false
										...
										elseif math.random(1,500) == 5 then
											data[vi] = OREID.c_tali
											void = false
										elseif math.random(1,500) == 6 then
											data[vi] = OREID.c_glowore
											void = false
										elseif math.random(1,500) == 7 then
											data[vi] = OREID.c_titan
											void = false
										elseif math.random(1,500) == 8 then
											data[vi] = OREID.c_glowore
											void = false
										elseif math.random(1,500) == 9 then
											data[vi] = OREID.c_glowore
											void = false
										elseif math.random(1,500) == 10 then
											data[vi] = OREID.c_glowore
											void = false
										elseif math.random(1,500) == 11 then
											data[vi] = OREID.c_glowore
											void = false
										elseif math.random(1,500) == 12 then
											data[vi] = OREID.c_glowore
											void = false
										elseif math.random(1,500) == 13 then
											data[vi] = OREID.c_chrom
											void = false
										elseif math.random(1,500) == 14 then
											data[vi] = OREID.c_lead
											void = false
										elseif math.random(1,500) == 15 then
											data[vi] = OREID.c_zinc
											void = false
										elseif math.random(1,500) == 16 then
											data[vi] = OREID.c_copp
											void = false
										else
											data[vi] = c_coalstone
									...
									elseif ystrata >= 0.33 then
										 ...
										 void = false
									elseif ystrata <= -0.11 
									and ystrata >= -0.22 then
										 data[vi] = c_adobe
										 void = false
									elseif ystrata <= 0.14 
									and ystrata >= 0.03 then
										 data[vi] = SEDID.c_claym
										 void = false
									elseif ystrata <= -0.33 then
									...
									if y < SEA then
										...
										if (y == SEA + 1 or y == SEA) then
											...
											if hum > 67  then  --boundary for wet climates
												...
												swamp(data, vi, 100, SEDID.c_dirt, SEDID.c_turfh, MISCID.c_river)
												void = false
										...
										--freezing cold
										elseif temp < 5 then
											swamp(data, vi, 3, SEDID.c_gravel, SEDID.c_gravelc, SEDID.c_gravelm, c_ice)
											void = false
										--permafrost
										elseif hum > 90 and temp < 16 then
											swamp(data, vi, 50, SEDID.c_dirt, SEDID.c_turff, c_ice)
											void = false
										-- hot arid
					...
					if y < SEA then
						...
						elseif not nocave then
							if nodu == c_stone then
								if n_terr > 0 then
									data[vi] = SEDID.c_gravel, c_basalt
									sedi = true
									void = false
								end
								if n_terr > 0.9 then
							...
							elseif nodu == c_stone2 then
							 	if n_terr2 > 0 then
									data[vi] = SEDID.c_sand, c_granite
									sedi = true
									void = false
								end
								if n_terr2 > 0.9 then
						...
						or nodu == c_marble
						or nodu == c_pumice
						or nodu == SEDID.c_siltc
						or nodu == SEDID.c_siltm
						or nodu == SEDID.c_siltf
						or nodu == SEDID.c_clay
						or nodu == SEDID.c_claym
						or nodu == SEDID.c_gravel
						or nodu == SEDID.c_gravelc
						or nodu == SEDID.c_gravelm
						or nodu == SEDID.c_gravelf
						or nodu == SEDID.c_turfh
						or nodu == SEDID.c_turff
						or nodu == SEDID.c_turfs
						or nodu == OREID.c_alatro
						or nodu == OREID.c_amethyst
						or nodu == OREID.c_arol
						or nodu == OREID.c_akalin
						or nodu == OREID.c_kalite
						or nodu == OREID.c_coal
						or nodu == OREID.c_glowore
						or nodu == OREID.c_mithril
						or nodu == OREID.c_lead
						or nodu == OREID.c_iron
						or nodu == OREID.c_iron2
						or nodu == OREID.c_copp
						or nodu == OREID.c_copp2
						or nodu == OREID.c_zinc
						or nodu == OREID.c_tali
						or nodu == OREID.c_tin
						or nodu == OREID.c_gold
						or nodu == OREID.c_quartz
						or nodu == OREID.c_silver
						or nodu == OREID.c_sulfur
						or nodu == OREID.c_chrom
						or nodu == OREID.c_ruby
						or nodu == OREID.c_emerald
						or nodu == OREID.c_sapphire
						or nodu == OREID.c_titan
						or nodu == OREID.c_topaz
						or nodu == OREID.c_uranium
						or nodu == OREID.c_diam
						or nodu == OREID.c_mese
						or nodu == c_obsid
						or nodu == c_coral)
						then
							can_sur = true
						...
						if can_sur and nodu ~= MISCID.c_ignore and nocave then
							...
							and nodu ~= c_dsand
							then
								data[vi] = SEDID.c_gravel, SEDID.c_siltm
								void = false
							--End of Cold zone
							end
